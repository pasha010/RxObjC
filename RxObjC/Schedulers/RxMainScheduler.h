...
/**
 * Abstracts work that needs to be performed on `MainThread`. In case `schedule` methods are called from main thread,
...
//! Singleton instance of RxMainScheduler
@property (class, readonly) RxMainScheduler *instance;

//! Singleton instance of `MainScheduler` that always schedules work asynchronously and doesn't perform optimizations for calls scheduled from main thread.
@property (class, readonly) RxSerialDispatchQueueScheduler *asyncInstance;
